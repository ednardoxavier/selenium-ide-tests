...
class Test02iTrackLoginPerformance:
    ...
    def test_02iTrackLoginPerformance(self):
        ...
        ActionChains(self.driver).move_to_element(self.driver.find_element(By.CSS_SELECTOR, "body"), 0, 0).perform()
        ActionChains(self.driver).move_to_element(self.driver.find_element(By.CSS_SELECTOR, ".mui-9wjka2")).perform()
        ActionChains(self.driver).move_to_element(self.driver.find_element(By.CSS_SELECTOR, "body"), 0, 0).perform()
        ...
        print("Teste de login performance executado com sucesso.")
