...
class Test04iTrackCadastroeperformance:
    ...
    def teardown_method(self, method):
      ...
      def test_04iTrackCadastroeperformance(self):
        ...
        self.driver.find_element(By.ID, "mui-p-14770-T-users").click()
        self.driver.find_element(By.ID, "mui-p-14770-T-receivers").click()
        self.driver.find_element(By.ID, "mui-p-14770-T-docs").click()
        self.driver.find_element(By.ID, "mui-p-14770-T-remans").click()
        self.driver.find_element(By.ID, "mui-p-14770-T-dealers").click()
        self.driver.find_element(By.ID, "mui-p-14770-T-transporters").click()
        self.driver.find_element(By.CSS_SELECTOR, "#drawer-settings-link .MuiTypography-root").click()
        self.driver.find_element(By.CSS_SELECTOR, "#drawer-dashboard-link .MuiTypography-root").click()
