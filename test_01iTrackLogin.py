...
class Test01iTrackLogin():
    ...
    def test_01iTrackLogin(self):
        ...
        self.driver.find_element(By.ID, "signin-email-input").send_keys("teste.agco@esparta.io")
        self.driver.find_element(By.ID, "signin-password-input").send_keys("adminteste")
